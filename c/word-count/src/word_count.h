...
// find - given a word and a collection of words, return the index at
// which the word occurs in the collection or -1 if it couldn't be found
int find(const char word[], const word_count_word_t words[MAX_WORDS]);

// is_apostrophe - determines whether or not a character in a given
// string is an apostrophe
